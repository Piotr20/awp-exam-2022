...
import { useLoaderData, useActionData, Link, Form, useTransition } from "@remix-run/react";
    ...
    <div className="  w-full h-full flex flex-col">
      ...
      <div className="w-full h-full relative bg-custom-white text-custom-black p-4 lg:grid lg:grid-cols-4 lg:gap-8">
        ...
        >
          <svg
            role="status"
            className="w-8 h-8 mr-2 text-gray-600 animate-spin dark:text-gray-200 fill-custom-purple"
            viewBox="0 0 100 101"
            fill="none"
